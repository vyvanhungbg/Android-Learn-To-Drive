package com.suspend.android.learntodrive.ui.diequestion
...
import com.suspend.android.learntodrive.databinding.FragmentQuestionDieBinding
...
private const val TAG = "QuestionDieFragment"

class QuestionDieFragment :
    BaseFragment<FragmentQuestionDieBinding>(FragmentQuestionDieBinding::inflate) {
    override val viewModel by viewModel<QuestionDieViewModel>()
    ...
    override fun initView() {
        ...
        binding.containerQuestion.layoutCardViewDescription.isVisible = true
    ...
    private fun initViewQuestion() {
        ...
        viewModel.question.observe(viewLifecycleOwner) {
            binding.containerQuestion.layoutCardViewDescription.isVisible = it.description.isNullOrEmpty().not()
